        ...
        <div class="col-12 col-lg-6">
            <div class="diab-card p-4 p-md-5 animate-fade-in">
                <div class="text-center mb-4">
                    <div class="admin-card-icon-wrapper mx-auto bg-diab-primary-light mb-3">
                        <i class="fa-solid fa-link fs-4 text-diab-primary"></i>
                    </div>
                ...
                <form method="POST" action="{{ route('doctor.link.store') }}">
                    @csrf
                    <div class="mb-4">
