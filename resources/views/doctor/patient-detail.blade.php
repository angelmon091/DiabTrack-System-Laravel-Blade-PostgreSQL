...
<main class="container-fluid py-4 px-md-5">
    <div class="row g-4">
        ...
        <section class="col-12 col-xl-9">
            ...
            {{-- Consejos Diarios Sugeridos por IA (publicados automáticamente) --}}
            <div class="diab-card p-4 mb-4 animate-fade-in" style="animation-delay: 0.45s; border-left: 5px solid var(--diab-primary);">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        ...
                        <span class="text-muted extra-small">Consejos generados por el asistente de IA y publicados automáticamente.</span>
                    </div>
                </div>

                @if($pendingTips->isEmpty())
                    <p class="text-muted small mb-0"><i class="fa-solid fa-circle-check text-success me-1"></i>No hay consejos recientes para este paciente.</p>
                @else
