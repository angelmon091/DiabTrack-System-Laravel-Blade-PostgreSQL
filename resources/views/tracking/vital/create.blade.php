        ...
        <form class="tracking-form-layout" action="{{ route('tracking.vital.store') }}" method="POST">
            ...
            <aside class="tracking-form-aside">
                <div class="tracking-panel">
                    <label class="d-flex justify-content-between align-items-center w-100 mb-3">
                        <span style="font-size: 1.1rem; font-weight: 700; color: var(--diab-text);">{{ __('¿Cuándo mediste?') }}</span>
                        <i class="fa-solid fa-circle-info info-icon opacity-50 text-muted" data-bs-toggle="tooltip" title="En ayunas: al despertar sin haber comido nada (8+ hrs). Antes de comer: justo antes de desayunar, comer o cenar. Después de comer: 1-2 horas después de cualquier comida. Al dormir: antes de acostarte."></i>
                    </label>
                        ...
                        @php
                            $moments = [
                                ...
                                [
                                    ...
                                    'desc' => '1-2 horas después de tu comida',
                                ],
                                [
                                    'id'   => 'Al Dormir',
                                    'icon' => 'fa-solid fa-moon',
                                    'label'=> 'Al Dormir',
                                    'desc' => 'Antes de acostarte',
                                ],
                            ];
                        @endphp
