    ...
    <div class="row g-4">
        ...
        <section class="col-12 col-xl-9">
            <div class="d-flex justify-content-between align-items-center mb-4 animate-fade-in">
                ...
                <div class="text-muted small d-none d-sm-block bg-white px-3 py-1 rounded-pill border">{{ date('d M, Y') }}</div>
            </div>
            ...
            <h5 class="fw-bold mb-4 fs-6 text-diab-text-secondary text-uppercase letter-spacing-1">Aspectos Importantes</h5>
            ...
            <div class="d-flex flex-column gap-3 mb-4">
                    ...
                    <div class="row align-items-center g-3">
                        ...
                        <div class="col-9 col-md-8 px-md-4">
                            <div class="progress-container shadow-sm border-0">
                                <div class="progress-bar-custom bg-diab-danger shadow" style="width: 75%; background-color: var(--diab-danger) !important;"></div>
                            </div>
                        </div>
                ...
                <div class="diab-card p-3 p-md-4 animate-fade-in" style="animation-delay: 0.8s;">
                    <div class="row align-items-center g-3">
                        ...
                        <div class="col-9 col-md-8 px-md-4">
                            <div class="progress-container shadow-sm border-0">
                                <div class="progress-bar-custom shadow" style="width: 87%; background-color: var(--diab-primary) !important;"></div>
                            </div>
                        </div>
